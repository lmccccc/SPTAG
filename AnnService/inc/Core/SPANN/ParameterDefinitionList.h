...
DefineSSDParameter(m_postingSegmentLengthsFile, std::string, std::string("posting_segment_lengths.bin"), "PostingSegmentLengthsFile")
DefineSSDParameter(m_tailSubindexFile, std::string, std::string("tail_subindex.bin"), "TailSubindexFile")
DefineSSDParameter(m_tagSubsetMaskFile, std::string, std::string("tag_subset_mask.bin"), "TagSubsetMaskFile")
