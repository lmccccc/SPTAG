    ...
    namespace Helper
    {
        ...
        public:
            ...
            virtual std::shared_ptr<VectorSet> GetVectorSet(SizeType start = 0, SizeType end = -1) const 
            {
                ...
                return std::shared_ptr<VectorSet>(new BasicVectorSet(ByteArray((std::uint8_t*)(m_vectors->GetVector(start)),
                    static_cast<std::size_t>(end - start) * m_vectors->PerVectorDataSize(), false),
