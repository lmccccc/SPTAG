...
BASE=DATA/"toolchains/postfilter_posting_fullrow_20260918"
PARENT=DATA/"comparisons/postfilter_posting_fullrow_20260918"
...
def case(mode): return f"native_{mode}_hitratio_0.01"
...
def initialize():
    ...
    checks={
        PARENT/"report.json":"949ab739d7542926f93ec92ad06055566613fb3e2be6ff0ccc5940a7fd612e6f",
        PARENT/"summary.json":"4a8e6bd2ccc41450afb6d3eec4c5b45ae43ac4580c24e500af50c949c210271d",
    ...
    protection={}
    roots=[HERE.with_name("postfilter_posting_fullrow_20260918"),BASE,PARENT,
    ...
    for scenario in ("broad_tag","extreme_tag","unfilter"):
        ...
        text=(HERE.with_name("postfilter_posting_fullrow_20260918")/
            f"{folder}/{scenario}_postfilter_graph_ratio_0.01.ini").read_text()
        for mode in ("graph","posting"):
            value=text.replace("postfilter_graph_ratio_0.01",case(mode))
            value=value.replace("postfilter_posting_fullrow_20260918",HERE.name)
            value=value.replace("PostFilterPostingMode=graph",f"NativePostfilterMode={mode}")
            value=value.replace("PostingActivationRatio","PostingFilterHitRatio")
