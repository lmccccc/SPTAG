...
def main(phase, variant):
    binary = TOOL / "matched-current" if variant == "frozen" else TOOL / "harness/matched-repair"
    ...
    sample = phase == "sample"
    suffix = "" if variant == "frozen" else "_repair"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--variant", choices=("frozen", "repair"), default="frozen")
