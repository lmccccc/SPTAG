"""One fixed physical visited-match ratio, six Broad and at most four sparse processes."""
import hashlib
import json
import os
...
TRACES=TRAJECTORY+(".decisions.f64",".rows.u64",".match.u64")
...
def validate(directory,scenario,mode,count,seconds):
    ...
    if scenario=="broad_tag" and mode=="graph":
        oracle=PARENT/"broad_tag_native_graph_hitratio_0.01_r1/nprobe_24"
    ...
    if count==32 and mode=="graph":
        oracle=PARENT/f"small_{scenario}_native_graph_hitratio_0.01/nprobe_24"
