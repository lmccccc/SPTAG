...
struct NativeNeighborHooks {
    bool diagnostics=false,capture=false,injected=false,gather=false;
    ...
    std::uint64_t sparseActivations=0,selectedActions=0,qualificationChecks=0;
    std::uint64_t ordinaryQualificationRequests=0,secondHopLoops=0,classifierPrescanEntries=0;
