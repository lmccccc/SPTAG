    ...
    for case in cases:
        ...
        shared = {k: v for k, v in pair[0].items()
                  if k not in ("shortcutmode", "shortcutcap", "headnavigationmode",
                               "shortcuteffectivedegree", "shortcutmemberlimit")}
            ...
            if mode == "profile":
                ...
                if case.startswith(("supplier", "control")):
                    ...
                    require(all(r["supplyStarts"] == 1 and r["supplyCalls"] == r["supplyReturns"]
                                and r["supplyMembers"] <= 2048 and r["supplyMaxQualified"] <= 16
        ...
        for scenario in scenarios:
            ...
            for case in (c for c in cases if c.startswith(("supplier", "control"))):
                ...
                usage[scenario][case] = {
                    ...
                    "distance_cap_exhausted_queries": sum(r["exhausted"] for r in data),
                    "member_ceiling_queries": sum(r["supplyMembers"] == 2048 for r in data)}
