...
void NativeSearch(SPTAG::BKT::Index<T>* bkt, SPTAG::COMMON::QueryResultSet<T>* result,
    ...
    const auto searchBegin = ShortcutFull::profile ? std::chrono::steady_clock::now()
        : std::chrono::steady_clock::time_point{};
    try {
    ...
    const auto finishBegin = ShortcutFull::profile ? std::chrono::steady_clock::now()
        : std::chrono::steady_clock::time_point{};
    bkt->BenchmarkRestore(std::move(original));
    Active() = nullptr; ShortcutBench::active = nullptr;
    ...
    o.supplyResetNs = s.resetNs;
o.supplyDegreeNs = s.degreeNs;
o.supplyQualifyNs = s.qualifyNs;
o.supplyDistanceNs = s.distanceNs;
o.supplyAdmitNs = s.admitNs;
o.supplyHelperNs = s.helperNs;
o.supplyStateClears = s.stateClears;
o.supplyShortRows = s.shortRows;
o.supplyQueueOffers = s.queueOffers;
o.supplyQueueAccepted = s.queueAccepted;
o.supplyQueueRejected = s.queueRejected;
o.supplyChildQueueOffers = s.childQueueOffers;
o.supplyChildQueueRejected = s.childQueueRejected;
o.supplyDirectCalls = s.directCalls;
    ...
    o.supplyUpperMembers = s.upperMembers; o.supplyLowerMembers = s.lowerMembers;
    o.supplyDiscovered = s.discovered; o.supplyDiscoveryReuse = s.discoveryReuse;
    o.supplyEntryCandidates = s.entryCandidates; o.supplyEntryCalls = s.entryCalls;
    o.supplyEntryBefore = s.entryBefore; o.supplyStartupChecks = s.startupChecks;
    o.supplyStartupCalls = s.startupCalls; o.supplyStartupBlocked = s.startupBlocked;
    o.supplyStartupBefore = s.startupBefore; o.supplyStartupAfter = s.startupAfter;
    o.supplyStartupQualified = s.startupQualified;
    o.supplyConnChecks = s.connChecks; o.supplyConnLow = s.connLow;
    o.supplyConnBefore = s.connBefore; o.supplyConnAfter = s.connAfter; o.supplyConnAdded = s.connAdded;
    o.supplyOrdinaryVisited = s.ordinaryVisited; o.supplyStartupConnected = s.startupConnected;
    if (ShortcutFull::capture) {
        ...
        o.entryIDs = e.entryIDs; o.entryScored = e.entryScored;
        o.startupAudits = e.startupAudits; o.discoveries = e.discoveries;
        o.connectivityAudits = e.connectivityAudits;
    }
